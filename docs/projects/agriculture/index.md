...
!!! abstract "What you'll build"
    A self-watering plant system. When the soil gets dry, it checks if there's water in the tank. If both conditions are met, it turns on a pump to water the plant automatically. If the water tank runs low, an LED warns you to refill.
