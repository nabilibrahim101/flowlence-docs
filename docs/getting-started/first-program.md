...
A device picker appears with all the supported boards. Find **ESP32 Plus** and click it.
...
The LED block isn't loaded by default. Add it from the extension library. Click the blue **Add Extension** button in the bottom-left corner of the screen, then in the search box type "LED".
...
<li markdown>Click **Connect** in the top bar.</li>
<li markdown>Pick the COM port that appears in the list.</li>
<li markdown>Click the green **Upload** button (top right) and wait about 30 seconds for the program to compile and flash.</li>
</ol>
