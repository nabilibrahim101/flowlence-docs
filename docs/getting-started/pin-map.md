...
Every G/V/S header already has G and V on it, so **you don't usually need to touch the POWER rail directly**. It's there for projects where you add an extra LED strip or a motor that needs its own supply.
